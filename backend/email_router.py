              ...
              <tr>
                <td>
                  <div style="display:inline-flex;align-items:center;gap:10px;">
                    ...
                    <span style="color:#FFFFFF;font-size:20px;font-weight:800;letter-spacing:-0.5px;">RxGuard</span>
                  </div>
        ...
        <tr>
          <td style="padding:24px 40px;">
            <p style="font-size:12px;color:#7B8FA6;margin:0;line-height:1.6;">
              This report was generated by RxGuard AI. The SHA-256 audit chain ensures
            ...
            <p style="font-size:11px;color:#9B9B9B;margin:12px 0 0;">
              &copy; 2026 RxGuard &bull; Powered by 5-Agent AI Pipeline
            </p>
          </td>
        </tr>
...
async def send_report_email(body: ReportEmailRequest):
    ...
    params = {
        ...
        "subject": f"RxGuard Verification Report — {body.audit_id}",
        "html": html_content,
    }
